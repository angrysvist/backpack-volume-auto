...
NEEDED_TRADE_VOLUME = 51000  # volume to trade, if 0 it will never stop
MIN_BALANCE_TO_LEFT = 0  # min amount to left on the balance, if 0, it is traded until the balance is equal to 0.

TRADE_AMOUNT = [100, 250]  # (works nearly from +-20%), minimum (3$) and maximum amount to trade in USD, if 0 it will trade on FULL balance
